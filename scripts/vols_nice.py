...
NOM_MODULE = "vols_nice"

PARAMETRES_PATH = "data/config/parametres_globaux.json"
CONFIG_PATH = "data/config/vols_nice.json"
ETAT_PATH = "data/etat/vols_nice_derniers_prix.json"
...
def main():
    ...
    for depart in config["depart"]:
        ...
        message = (
            f"🏖️ *Vol repéré, {depart} vers Nice*\n"
